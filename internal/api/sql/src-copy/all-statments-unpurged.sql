...
bin/nanpa_type_filter.pl:315:INSERT INTO vicidial_nanpa_filter_log SET output_code=?/* db_output_code */,user=?/* TRIGGER_user */,status='LAUNCHED',server_ip=?/* VARserver_ip */,list_id=?/* list_id */,start_time=NOW(),update_time=NOW(),status_line='Starting...',script_output='Starting...CELLPHONE LIST ID: $cellphone_list_idLANDLINE LIST ID: $landline_list_idINVALID LIST ID: $invalid_list_idVL FIELD UPDATE: $vl_field_updateEXCLUDE FIELD: $exclude_fieldEXCLUDE VALUE: $exclude_valueINCLUDE FIELD: $include_fieldINCLUDE VALUE: $include_value' ON DUPLICATE KEY UPDATE status='LAUNCHED',server_ip=?/* VARserver_ip */,list_id=?/* list_id */,update_time=NOW(),status_line='Starting...',script_output=CONCAT(script_output,'Starting...CELLPHONE LIST ID: $cellphone_list_idLANDLINE LIST ID: $landline_list_idINVALID LIST ID: $invalid_list_idVL FIELD UPDATE: $vl_field_updateEXCLUDE FIELD: $exclude_fieldEXCLUDE VALUE: $exclude_valueINCLUDE FIELD: $include_fieldINCLUDE VALUE: $include_value');
bin/nanpa_type_filter.pl:350:SELECT lead_id,phone_number from vicidial_list $list_idSQL $excludeSQL $includeSQL;
bin/nanpa_type_filter.pl:383:UPDATE vicidial_nanpa_filter_log SET status='LEADS_GATHERED',leads_count=?/* rec_count */,update_time=NOW(),status_line=?/* "Leads Gathered: $rec_count" */,script_output=CONCAT(script_output,?/* "Leads Gathered: $rec_count" */) where output_code=?/* db_output_code */;
...
bin/nanpa_type_filter.pl:506:UPDATE vicidial_nanpa_filter_log SET status='COMPLETED',filter_count=?/* rec_count */,update_time=NOW(),status_line=?/* "Process Completed: $secZ seconds" */,script_output=CONCAT(script_output,?/* "Process Completed: $secZ seconds   INVALID:    $invalid   CELLPHONE:  $cellphone   LANDLINE:   $landline" */) where output_code=?/* db_output_code */;
...
bin/AST_VDadapt.pl:2350:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_one */;
bin/AST_VDadapt.pl:2365:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_one */ and status IN($camp_ANS_STAT_SQL);
bin/AST_VDadapt.pl:2377:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_one */ and status IN('DROP','XDROP');
bin/AST_VDadapt.pl:2424:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_current_hour_date */;
...
bin/AST_VDadapt.pl:2517:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_today $j:00:00 */ and call_date < ?/* VL_today $j_next:00:00 */;
...
bin/AST_VDadapt.pl:2549:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VDL_date */;
bin/AST_VDadapt.pl:2569:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_current_hour_date */ and status IN($camp_ANS_STAT_SQL);
...
bin/AST_VDadapt.pl:2662:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_today $j:00:00 */ and call_date < ?/* VL_today $j_next:00:00 */ and status IN($camp_ANS_STAT_SQL);
...
bin/AST_VDadapt.pl:2694:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VDL_date */ and status IN($camp_ANS_STAT_SQL);
bin/AST_VDadapt.pl:2711:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_current_hour_date */ and status IN($camp_AM_STAT_SQL) and user != 'VDAD';
...
bin/AST_VDadapt.pl:2804:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_today $j:00:00 */ and call_date < ?/* VL_today $j_next:00:00 */ and status IN($camp_AM_STAT_SQL) and user != 'VDAD';
...
bin/AST_VDadapt.pl:2836:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VDL_date */ and status IN($camp_AM_STAT_SQL) and user != 'VDAD';
bin/AST_VDadapt.pl:2853:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_current_hour_date */ and status IN($camp_ANS_STAT_SQL) and user != 'VDAD';
...
bin/AST_VDadapt.pl:2946:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_today $j:00:00 */ and call_date < ?/* VL_today $j_next:00:00 */ and status IN($camp_ANS_STAT_SQL) and user != 'VDAD';
...
bin/AST_VDadapt.pl:2978:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VDL_date */ and status IN($camp_ANS_STAT_SQL) and user != 'VDAD';
bin/AST_VDadapt.pl:2995:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_current_hour_date */ and status IN('DROP','XDROP');
...
bin/AST_VDadapt.pl:3088:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VL_today $j:00:00 */ and call_date < ?/* VL_today $j_next:00:00 */ and status IN('DROP','XDROP');
...
bin/AST_VDadapt.pl:3119:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VDL_date */ and status IN('DROP','XDROP');
bin/AST_VDadapt.pl:3184:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_hour */;
bin/AST_VDadapt.pl:3198:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_hour */ and status IN($camp_ANS_STAT_SQL);
bin/AST_VDadapt.pl:3210:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_hour */ and status IN('DROP','XDROP');
bin/AST_VDadapt.pl:3229:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_halfhour */;
bin/AST_VDadapt.pl:3243:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_halfhour */ and status IN($camp_ANS_STAT_SQL);
bin/AST_VDadapt.pl:3255:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_halfhour */ and status IN('DROP','XDROP');
bin/AST_VDadapt.pl:3273:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_five */;
bin/AST_VDadapt.pl:3287:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_five */ and status IN($camp_ANS_STAT_SQL);
bin/AST_VDadapt.pl:3299:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date > ?/* VDL_five */ and status IN('DROP','XDROP');
...
bin/AST_VDadapt.pl:3372:SELECT count(*) from vicidial_log FORCE INDEX (call_date)  where campaign_id=?/* campaign_id[$i] */ and call_date >= ?/* VDL_date */ and status IN($CATstatusesSQL);
...
bin/AST_VDadapt.pl:4494:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */;
...
bin/AST_VDadapt.pl:4587:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */;
...
bin/AST_VDadapt.pl:4619:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */;
bin/AST_VDadapt.pl:4638:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */ and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
...
bin/AST_VDadapt.pl:4731:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */ and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
...
bin/AST_VDadapt.pl:4763:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */ and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
bin/AST_VDadapt.pl:4780:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */ and status IN('DROP','XDROP');
...
bin/AST_VDadapt.pl:4873:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */ and status IN('DROP','XDROP');
...
bin/AST_VDadapt.pl:4905:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */ and status IN('DROP','XDROP');
bin/AST_VDadapt.pl:4932:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */ and queue_seconds <= $answer_sec_pct_rt_stat_one and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
...
bin/AST_VDadapt.pl:5025:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */ and queue_seconds <= $answer_sec_pct_rt_stat_one and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
...
bin/AST_VDadapt.pl:5057:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */ and queue_seconds <= $answer_sec_pct_rt_stat_one and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
bin/AST_VDadapt.pl:5073:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */ and queue_seconds <= $answer_sec_pct_rt_stat_two and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
...
bin/AST_VDadapt.pl:5166:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */ and queue_seconds <= $answer_sec_pct_rt_stat_two and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
...
bin/AST_VDadapt.pl:5198:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */ and queue_seconds <= $answer_sec_pct_rt_stat_two and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
bin/AST_VDadapt.pl:5215:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */ and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
...
bin/AST_VDadapt.pl:5308:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */ and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
...
bin/AST_VDadapt.pl:5340:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */ and status NOT IN('DROP','XDROP','HXFER','QVMAIL','HOLDTO','LIVE','QUEUE','TIMEOT','AFTHRS','NANQUE','INBND','MAXCAL');
bin/AST_VDadapt.pl:5358:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */ and status IN('DROP','XDROP');
...
bin/AST_VDadapt.pl:5451:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */ and status IN('DROP','XDROP');
...
bin/AST_VDadapt.pl:5483:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */ and status IN('DROP','XDROP');
bin/AST_VDadapt.pl:5501:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */;
...
bin/AST_VDadapt.pl:5594:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */;
...
bin/AST_VDadapt.pl:5626:SELECT sum(queue_seconds) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */;
...
bin/AST_VDadapt.pl:5700:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_current_hour_date */ and status IN($CATstatusesSQL);
...
bin/AST_VDadapt.pl:5793:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date >= ?/* VCL_today $j:00:00 */ and call_date < ?/* VCL_today $j_next:00:00 */ and status IN($CATstatusesSQL);
...
bin/AST_VDadapt.pl:5825:SELECT count(*) from vicidial_closer_log FORCE INDEX (call_date)  where campaign_id=?/* group_id[$p] */ and call_date > ?/* VDL_date */ and status IN($CATstatusesSQL);
...
bin/AST_VDadapt.pl:6471:INSERT INTO vicidial_lead_call_quota_counts SET lead_id=?/* CIDlead_id */,list_id=?/* VLlist_id */,first_call_date=?/* VDLcall_datetime */,last_call_date=?/* VDLcall_datetime */,status=?/* temp_status */,called_count=?/* VLcalled_count */,day_one_calls='1',rank=?/* tempVLrank */,modify_date=NOW() ,session_six_calls='1',session_six_today_calls='1';
...
bin/AST_VDsales_export_SFTPSSH2.pl:604:select vicidial_log.user,first_name,last_name,address1,address2,city,state,postal_code,vicidial_list.phone_number,vicidial_list.email,security_phrase,vicidial_list.comments,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),vicidial_list.lead_id,vicidial_users.full_name,vicidial_log.status,vicidial_list.vendor_lead_code,vicidial_list.source_id,vicidial_log.list_id,title,address3,last_local_call_time,uniqueid,length_in_sec,vicidial_list.list_id,vicidial_list.list_id,UTC_TIMESTAMP(vicidial_log.call_date),vicidial_campaigns.campaign_name,vicidial_campaigns.campaign_cid from vicidial_list,vicidial_log,vicidial_users,vicidial_campaigns where $campaignSQL $sale_statusesSQL and call_date > ?/* shipdate 00:00:01 */ and call_date < ?/* shipdate 23:59:59 */ and vicidial_log.lead_id=vicidial_list.lead_id and vicidial_users.user=vicidial_log.user and vicidial_log.campaign_id=vicidial_campaigns.campaign_id order by call_date;
bin/AST_VDsales_export_SFTPSSH2.pl:607:select vicidial_log.user,8,8,8,8,8,8,8,vicidial_log.phone_number,8,8,8,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),vicidial_log.lead_id,vicidial_users.full_name,vicidial_log.status,8,8,vicidial_log.list_id,8,8,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),uniqueid,length_in_sec,vicidial_log.list_id,vicidial_log.list_id,UTC_TIMESTAMP(vicidial_log.call_date),vicidial_campaigns.campaign_name,vicidial_campaigns.campaign_cid from vicidial_log,vicidial_users,vicidial_campaigns where $campaignSQL $sale_statusesSQL and call_date > ?/* shipdate 00:00:01 */ and call_date < ?/* shipdate 23:59:59 */ and vicidial_users.user=vicidial_log.user and vicidial_log.campaign_id=vicidial_campaigns.campaign_id order by call_date;
bin/AST_VDsales_export_SFTPSSH2.pl:664:select vicidial_closer_log.user,first_name,last_name,address1,address2,city,state,postal_code,vicidial_list.phone_number,vicidial_list.email,security_phrase,vicidial_list.comments,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),vicidial_list.lead_id,vicidial_users.full_name,vicidial_closer_log.status,vicidial_list.vendor_lead_code,vicidial_list.source_id,vicidial_closer_log.list_id,campaign_id,title,address3,last_local_call_time,xfercallid,closecallid,uniqueid,length_in_sec,queue_seconds,vicidial_list.list_id,vicidial_list.list_id,UTC_TIMESTAMP(vicidial_closer_log.call_date),agent_alert_delay from vicidial_list,vicidial_closer_log,vicidial_users,vicidial_inbound_groups where $with_inboundSQL $close_statusesSQL and call_date > ?/* shipdate 00:00:01 */ and call_date < ?/* shipdate 23:59:59 */ and vicidial_closer_log.lead_id=vicidial_list.lead_id and vicidial_users.user=vicidial_closer_log.user and vicidial_inbound_groups.group_id=vicidial_closer_log.campaign_id order by call_date;
bin/AST_VDsales_export_SFTPSSH2.pl:667:select vicidial_closer_log.user,8,8,8,8,8,8,8,vicidial_closer_log.phone_number,8,8,8,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),vicidial_closer_log.lead_id,vicidial_users.full_name,vicidial_closer_log.status,8,8,vicidial_closer_log.list_id,campaign_id,8,8,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),xfercallid,closecallid,uniqueid,length_in_sec,queue_seconds,vicidial_closer_log.list_id,vicidial_closer_log.list_id,UTC_TIMESTAMP(vicidial_closer_log.call_date),agent_alert_delay from vicidial_closer_log,vicidial_users,vicidial_inbound_groups where $with_inboundSQL $close_statusesSQL and call_date > ?/* shipdate 00:00:01 */ and call_date < ?/* shipdate 23:59:59 */ and vicidial_users.user=vicidial_closer_log.user and vicidial_inbound_groups.group_id=vicidial_closer_log.campaign_id order by call_date;
...
bin/AST_VDsales_export_SFTPSSH2.pl:1182:select did_pattern,did_description,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */) from vicidial_inbound_dids vid,vicidial_did_log vdl where uniqueid=?/* uniqueid */ and call_date > ?/* shipdate 00:00:01 */ and call_date <= ?/* call_date */ and vid.did_id=vdl.did_id order by call_date desc limit 1;
bin/AST_VDsales_export_SFTPSSH2.pl:1197:select vc.campaign_cid,vc.campaign_name,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */) from vicidial_campaigns vc,vicidial_log vl where lead_id=?/* lead_id */ and call_date > ?/* shipdate 00:00:01 */ and call_date <= ?/* call_date */ and vc.campaign_id=vl.campaign_id order by call_date desc limit 1;
bin/AST_VDsales_export_SFTPSSH2.pl:1384:select CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),order_id,appointment_date,appointment_time,call_notes from vicidial_call_notes where lead_id=?/* lead_id */ and vicidial_id=?/* uniqueid */ and call_date > ?/* shipdate 00:00:01 */ and call_date < ?/* shipdate 23:59:59 */ order by call_date desc limit 1;
...
bin/VICIDIAL_UPDATE_leads_status_file.pl:263:UPDATE_IN directory: |$dir1|;
...
bin/AST_CRON_audio_1_move_mix.pl:292:UPDATE recording_log set location=?/* HTTP://$server_ip/RECORDINGS/$ALLfile */ ,length_in_sec=?/* soxi_sec */,length_in_min=?/* soxi_min */ where recording_id=?/* recording_id */;
...
bin/AST_VDhopper.pl:459:DELETE from vicidial_hopper where list_id IN($inactive_lists) and source!='C';
bin/AST_VDhopper.pl:479:SELECT count(*) FROM vicidial_callbacks where callback_time <= ?/* now_date */ and status='ACTIVE' and campaign_id IN(?/* CLIcampaign */) and vicidial_callbacks.list_id NOT IN($inactive_lists);
bin/AST_VDhopper.pl:483:SELECT count(*) FROM vicidial_callbacks where callback_time <= ?/* now_date */ and status='ACTIVE' and vicidial_callbacks.list_id NOT IN($inactive_lists);
bin/AST_VDhopper.pl:499:SELECT vicidial_callbacks.lead_id,recipient,campaign_id,vicidial_callbacks.list_id,gmt_offset_now,state,vicidial_callbacks.lead_status,vendor_lead_code FROM vicidial_callbacks,vicidial_list where callback_time <= ?/* now_date */ and vicidial_callbacks.status='ACTIVE' and vicidial_callbacks.lead_id=vicidial_list.lead_id and vicidial_callbacks.campaign_id IN(?/* CLIcampaign */) and vicidial_list.list_id NOT IN($inactive_lists);
bin/AST_VDhopper.pl:503:SELECT vicidial_callbacks.lead_id,recipient,campaign_id,vicidial_callbacks.list_id,gmt_offset_now,state,vicidial_callbacks.lead_status,vendor_lead_code FROM vicidial_callbacks,vicidial_list where callback_time <= ?/* now_date */ and vicidial_callbacks.status='ACTIVE' and vicidial_callbacks.lead_id=vicidial_list.lead_id and vicidial_list.list_id NOT IN($inactive_lists);
...
bin/AST_VDhopper.pl:2590:SELECT count(*) FROM vicidial_list FORCE INDEX (list_id)  where called_since_last_reset='N' and status IN($STATUSsql[$i]) and ($list_id_sql[$i]) and ($all_gmtSQL[$i]) $lead_filter_sql[$i] $DLTsql[$i] $CCLsql[$i];
bin/AST_VDhopper.pl:2595:SELECT count(*) FROM vicidial_list FORCE INDEX (list_id)  where called_since_last_reset='N' and ($list_mix_dialableSQL) and ($all_gmtSQL[$i]) $lead_filter_sql[$i] $DLTsql[$i] $CCLsql[$i];
bin/AST_VDhopper.pl:2612:SELECT count(*) FROM vicidial_list FORCE INDEX (list_id)  where called_since_last_reset='N' and status IN('NEW') and ($list_id_sql[$i]) and ($all_gmtSQL[$i]) $lead_filter_sql[$i] $DLTsql[$i];
...
bin/AST_VDhopper.pl:2755:SELECT lead_id,list_id,gmt_offset_now,phone_number,state,status,modify_date,user,vendor_lead_code FROM vicidial_list FORCE INDEX (list_id)  where $recycle_SQL[$i] and ($list_id_sql[$i]) and lead_id NOT IN($lead_id_lists) $vlc_dup_check_SQL and ($all_gmtSQL[$i]) $lead_filter_sql[$i] $CCLsql[$i] $DLTsql[$i] $order_stmt limit $hopper_level[$i];
...
bin/nanpa_type_preload.pl:810:select phone from nanpa_wired_to_wireless '.$exc_clause_prefix.$exc_clause;
...
bin/nanpa_type_preload.pl:938:select phone from nanpa_wireless_to_wired '.$exc_clause_prefix.$exc_clause;
...
bin/AST_DNCcom_filter.pl:207:SELECT lead_id, phone_number, status, list_id FROM vicidial_list WHERE list_id IN ($CLIlists) AND status NOT IN ($skip_statuses) AND lead_id > $lead_id_pos ORDER BY lead_id LIMIT $lead_grab;
...
bin/AST_VDsales_export.pl:763:select vicidial_closer_log.user,first_name,last_name,address1,address2,city,state,postal_code,vicidial_list.phone_number,vicidial_list.email,security_phrase,vicidial_list.comments,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),vicidial_list.lead_id,vicidial_users.full_name,vicidial_closer_log.status,vicidial_list.vendor_lead_code,vicidial_list.source_id,vicidial_closer_log.list_id,campaign_id,title,address3,last_local_call_time,xfercallid,closecallid,uniqueid,length_in_sec,queue_seconds,vicidial_list.list_id,vicidial_list.list_id,UTC_TIMESTAMP(vicidial_closer_log.call_date),agent_alert_delay from vicidial_list,vicidial_closer_log,vicidial_users,vicidial_inbound_groups where $with_inboundSQL $close_statusesSQL and call_date >= ?/* shipdate 00:00:00 */ and call_date <= ?/* shipdate 23:59:59 */ and vicidial_closer_log.lead_id=vicidial_list.lead_id and vicidial_users.user=vicidial_closer_log.user and vicidial_inbound_groups.group_id=vicidial_closer_log.campaign_id order by call_date;
bin/AST_VDsales_export.pl:766:select vicidial_closer_log.user,8,8,8,8,8,8,8,vicidial_closer_log.phone_number,8,8,8,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),vicidial_closer_log.lead_id,vicidial_users.full_name,vicidial_closer_log.status,8,8,vicidial_closer_log.list_id,campaign_id,8,8,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),xfercallid,closecallid,uniqueid,length_in_sec,queue_seconds,vicidial_closer_log.list_id,vicidial_closer_log.list_id,UTC_TIMESTAMP(vicidial_closer_log.call_date),agent_alert_delay from vicidial_closer_log,vicidial_users,vicidial_inbound_groups where $with_inboundSQL $close_statusesSQL and call_date >= ?/* shipdate 00:00:00 */ and call_date <= ?/* shipdate 23:59:59 */ and vicidial_users.user=vicidial_closer_log.user and vicidial_inbound_groups.group_id=vicidial_closer_log.campaign_id order by call_date;
...
bin/AST_VDsales_export.pl:1277:select did_pattern,did_description,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */) from vicidial_inbound_dids vid,vicidial_did_log vdl where uniqueid=?/* uniqueid */ and call_date >= ?/* shipdate 00:00:00 */ and call_date <= ?/* call_date */ and vid.did_id=vdl.did_id order by call_date desc limit 1;
bin/AST_VDsales_export.pl:1292:select vc.campaign_cid,vc.campaign_name,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */) from vicidial_campaigns vc,vicidial_log vl where lead_id=?/* lead_id */ and call_date >= ?/* shipdate 00:00:00 */ and call_date <= ?/* call_date */ and vc.campaign_id=vl.campaign_id order by call_date desc limit 1;
bin/AST_VDsales_export.pl:1479:select CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),order_id,appointment_date,appointment_time,call_notes from vicidial_call_notes where lead_id=?/* lead_id */ and vicidial_id=?/* uniqueid */ and call_date >= ?/* shipdate 00:00:00 */ and call_date <= ?/* shipdate 23:59:59 */ order by call_date desc limit 1;
...
bin/AST_VDremote_agents.pl:1633:UPDATE vicidial_lead_call_quota_counts SET last_call_date=?/* VDLcall_datetime */,status=?/* temp_status */,called_count=?/* VLcalled_count */,rank=?/* tempVLrank */,modify_date=NOW() ,session_one_calls=(session_one_calls + 1),session_one_today_calls=(session_one_today_calls + 1) $day_updateSQL where lead_id=?/* CIDlead_id */ and list_id=?/* VLlist_id */;
...
bin/AST_VDremote_agents.pl:1646:INSERT INTO vicidial_lead_call_quota_counts SET lead_id=?/* CIDlead_id */,list_id=?/* VLlist_id */,first_call_date=?/* VDLcall_datetime */,last_call_date=?/* VDLcall_datetime */,status=?/* temp_status */,called_count=?/* VLcalled_count */,day_one_calls='1',rank=?/* tempVLrank */,modify_date=NOW() ,session_six_calls='1',session_six_today_calls='1';
...
bin/AST_inbound_email_parser.pl:634:insert into inbound_email_attachments(email_row_id, filename, file_type, file_encoding, file_size, file_extension, file_contents) VALUES '.substr($multistmt,0,-1);
bin/AST_inbound_email_parser.pl:638:insert into inbound_email_attachments(email_row_id, filename, file_type, file_encoding, file_size, file_extension, file_contents) VALUES '.substr($output_multistmt,0,-1);
...
bin/AST_inbound_email_parser.pl:1006:insert into inbound_email_attachments(email_row_id, filename, file_type, file_encoding, file_size, file_extension, file_contents) VALUES '.substr($multistmt,0,-1);
bin/AST_inbound_email_parser.pl:1009:insert into inbound_email_attachments(email_row_id, filename, file_type, file_encoding, file_size, file_extension, file_contents) VALUES '.substr($output_multistmt,0,-1);
...
bin/AST_inbound_export.pl:339:SELECT lead_id,call_date,length_in_sec,phone_number,status,user,campaign_id from vicidial_closer_log FORCE INDEX (call_date)  where call_date >= ?/* shipdate 00:00:00 */ and call_date <= ?/* shipdate_end 23:59:59 */ $ingroupsSQL;
...
bin/AST_cleanup_agent_log.pl:476:SELECT call_date,lead_id,uniqueid,user,status from vicidial_log and call_date > ?/* TDSQLdate */ and call_date < ?/* FDSQLdate */_where and user NOT IN('','VDAC','VDAD') order by call_date;
...
bin/AST_cleanup_agent_log.pl:592:SELECT user,parked_time,UTC_TIMESTAMP(parked_time),parked_sec,lead_id,uniqueid from park_log where parked_sec > 0 and parked_time > ?/* TDSQLdate */ and parked_time < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:616:SELECT talk_epoch,agent_log_id from vicidial_agent_log where lead_id=?/* Vlead_id[$i] */ and uniqueid=?/* Vuniqueid[$i] */ and user=?/* Vuser[$i] */ and talk_epoch >= ?/* Vpark_epoch[$i] */ and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:634:SELECT start_epoch,length_in_sec,queue_seconds from vicidial_closer_log where lead_id=?/* Vlead_id[$i] */ and uniqueid=?/* Vuniqueid[$i] */ and user=?/* Vuser[$i] */ and call_date > ?/* TDSQLdate */ and call_date < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:651:SELECT start_epoch,length_in_sec from vicidial_log where lead_id=?/* Vlead_id[$i] */ and uniqueid=?/* Vuniqueid[$i] */ and user=?/* Vuser[$i] */ and call_date > ?/* TDSQLdate */ and call_date < ?/* FDSQLdate */;
...
bin/AST_cleanup_agent_log.pl:719:SELECT user,agent_log_id,pause_epoch,wait_epoch,talk_epoch,dispo_epoch,UTC_TIMESTAMP(event_time),server_ip,campaign_id,user_group from vicidial_agent_log where sub_status='LAGGED' and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:762:SELECT count(*) from vicidial_agent_log where user=?/* Vuser[$i] */ and pause_epoch=?/* Vlast_epoch[$i] */ and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */;
...
bin/AST_cleanup_agent_log.pl:812:SELECT time_id,agent FROM queue_log where verb='PAUSEREASON' and data1 NOT IN('LAGGED') and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */_H order by time_id;
...
bin/AST_cleanup_agent_log.pl:983:SELECT time_id,call_id,queue,verb,serverid FROM queue_log where verb IN('ENTERQUEUE','CALLOUTBOUND') and serverid=?/* queuemetrics_log_id */ and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */_H order by time_id;
...
bin/AST_cleanup_agent_log.pl:1102:SELECT time_id,agent FROM queue_log where verb='PAUSEREASON' and data1='LAGGED' and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */_H order by time_id;
...
bin/AST_cleanup_agent_log.pl:1165:SELECT time_id,agent FROM queue_log where verb IN('AGENTLOGOFF','AGENTCALLBACKLOGOFF') and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */_H order by time_id;
...
bin/AST_cleanup_agent_log.pl:1228:SELECT time_id,agent FROM queue_log where verb IN('CONNECT') and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */_H order by time_id;
...
bin/AST_cleanup_agent_log.pl:1303:SELECT time_id,agent,verb,serverid FROM queue_log where verb IN('AGENTLOGIN','AGENTCALLBACKLOGIN') and serverid=?/* queuemetrics_log_id */ and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */ order by time_id;
...
bin/AST_cleanup_agent_log.pl:1366:SELECT count(*) as tally,lead_id,end_epoch from vicidial_log and call_date > ?/* TDSQLdate */ and call_date < ?/* FDSQLdate */_where group by lead_id,end_epoch order by tally desc;
bin/AST_cleanup_agent_log.pl:1395:SELECT uniqueid,start_epoch,user,status,length_in_sec from vicidial_log and call_date > ?/* TDSQLdate */ and call_date < ?/* FDSQLdate */_where and lead_id=?/* dup_lead[$h] */ and end_epoch=?/* dup_end[$h] */ order by start_epoch;
...
bin/AST_cleanup_agent_log.pl:1452:SELECT * from ((SELECT user, pause_epoch, count(*) as ct from vicidial_agent_log where ( (pause_sec > 0) or (wait_sec > 0) or (talk_sec > 0) or (dispo_sec > 0) ) and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */ group by user, pause_epoch) as dupes) where ct>1;
...
bin/AST_cleanup_agent_log.pl:1535:SELECT uniqueid,lead_id,start_epoch,end_epoch,length_in_sec from vicidial_log and call_date > ?/* TDSQLdate */ and call_date < ?/* FDSQLdate */_where and ( (length_in_sec > 86400) or (length_in_sec < -86400) ) order by call_date;
...
bin/AST_cleanup_agent_log.pl:1576:SELECT closecallid,lead_id,start_epoch,end_epoch,length_in_sec from vicidial_closer_log and call_date > ?/* TDSQLdate */ and call_date < ?/* FDSQLdate */_where and ( (length_in_sec > 86400) or (length_in_sec < -86400) ) order by call_date;
...
bin/AST_cleanup_agent_log.pl:1627:SELECT agent_log_id,pause_epoch,wait_epoch from vicidial_agent_log where pause_sec>43999 and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:1657:UPDATE vicidial_agent_log set pause_sec=?/* pause_sec[$h] */ where agent_log_id=?/* agent_log_id[$h] */;
bin/AST_cleanup_agent_log.pl:1673:SELECT agent_log_id,wait_epoch,talk_epoch from vicidial_agent_log where wait_sec>43999 and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:1702:UPDATE vicidial_agent_log set wait_sec=?/* wait_sec[$h] */ where agent_log_id=?/* agent_log_id[$h] */;
bin/AST_cleanup_agent_log.pl:1718:SELECT agent_log_id,talk_epoch,dispo_epoch from vicidial_agent_log where talk_sec>43999 and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:1747:UPDATE vicidial_agent_log set talk_sec=?/* talk_sec[$h] */ where agent_log_id=?/* agent_log_id[$h] */;
bin/AST_cleanup_agent_log.pl:1763:UPDATE vicidial_agent_log set dispo_sec='0' where dispo_sec>43999 and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:1774:UPDATE vicidial_closer_log set length_in_sec=(end_epoch - start_epoch) where length_in_sec < 1 and end_epoch > 1000 and call_date > ?/* TDSQLdate */ and call_date < ?/* FDSQLdate */;
bin/AST_cleanup_agent_log.pl:1803:SELECT distinct user from vicidial_agent_log where user != '' and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */ order by user;
bin/AST_cleanup_agent_log.pl:1822:SELECT agent_log_id,pause_epoch,pause_sec,wait_epoch,wait_sec,talk_epoch,talk_sec,dispo_epoch,dispo_sec,dead_epoch,dead_sec,event_time from vicidial_agent_log where user=?/* Vuser[$i] */ and event_time > ?/* TDSQLdate */ and event_time < ?/* FDSQLdate */ order by event_time, agent_log_id;
...
bin/AST_cleanup_agent_log.pl:2068:SELECT time_id,call_id,queue,agent,verb,serverid FROM queue_log where verb IN('ENTERQUEUE','CALLOUTBOUND') and serverid=?/* queuemetrics_log_id */ and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */ order by time_id;
bin/AST_cleanup_agent_log.pl:2091:SELECT time_id,call_id,queue,agent,verb,serverid,data1 FROM queue_log where verb='CONNECT' and call_id=?/* call_id[$h] */ and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */;
...
bin/AST_cleanup_agent_log.pl:2386:SELECT time_id,call_id,queue,agent,serverid,data4 FROM queue_log where verb='COMPLETEAGENT' and serverid=?/* queuemetrics_log_id */ and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */ order by time_id;
...
bin/AST_cleanup_agent_log.pl:2439:SELECT call_id, count(*) FROM queue_log WHERE verb IN('COMPLETEAGENT','COMPLETECALLER','TRANSFER') and serverid=?/* queuemetrics_log_id */ and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */_H GROUP BY call_id HAVING count(*)>1 ORDER BY count(*) DESC;
...
bin/AST_cleanup_agent_log.pl:2467:SELECT call_id, time_id FROM queue_log WHERE verb IN('COMPLETEAGENT') and data2 < '0' and serverid=?/* queuemetrics_log_id */ and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */_H;
...
bin/AST_cleanup_agent_log.pl:2537:SELECT time_id,call_id,queue,agent,serverid,data4 FROM queue_log where verb='COMPLETECALLER' and serverid=?/* queuemetrics_log_id */ and time_id > ?/* TDtarget */ and time_id < ?/* FDtarget */ order by time_id;
...
bin/AST_CRON_audio_1_move_VDonly.pl:537:UPDATE recording_log set location=?/* HTTP://$server_ip/RECORDINGS/$ALLfile */ $filenameSQL ,length_in_sec=?/* soxi_sec */,length_in_min=?/* soxi_min */ where recording_id=?/* recording_id */;
...
bin/AST_VDauto_dial.pl:2415:UPDATE vicidial_lead_call_quota_counts SET last_call_date=?/* VDLcall_datetime */,status=?/* CLnew_status */,called_count=?/* VLcalled_count */,rank=?/* tempVLrank */,modify_date=NOW() ,session_one_calls=(session_one_calls + 1),session_one_today_calls=(session_one_today_calls + 1) $day_updateSQL where lead_id=?/* CLlead_id */ and list_id=?/* VLlist_id */ and modify_date < NOW();
...
bin/AST_VDauto_dial.pl:2428:INSERT INTO vicidial_lead_call_quota_counts SET lead_id=?/* CLlead_id */,list_id=?/* VLlist_id */,first_call_date=?/* VDLcall_datetime */,last_call_date=?/* VDLcall_datetime */,status=?/* CLnew_status */,called_count=?/* VLcalled_count */,day_one_calls='1',rank=?/* tempVLrank */,modify_date=NOW() ,session_six_calls='1',session_six_today_calls='1';
...
bin/AST_activity_log_export.pl:452:SELECT user,CONVERT_TZ(event_time,?/* SQLtimezone */,?/* SQLoffset_timezone */),lead_id,campaign_id,pause_sec,wait_sec,talk_sec,dispo_sec,dead_sec,status,agent_log_id from vicidial_agent_log where $VALcampaignSQL and $VALdateSQL order by agent_log_id;
bin/AST_activity_log_export.pl:526:SELECT user,location,lead_id,recording_id,CONVERT_TZ(start_time,?/* SQLtimezone */,?/* SQLoffset_timezone */) from $recording_log where $RECdateSQL order by recording_id;
...
bin/AST_VDcall_quotas.pl:881:SELECT count(*) FROM vicidial_list FORCE INDEX (list_id)  where list_id=?/* LISTlist_id[$d] */ and status='NEW' and ($RETURN_all_gmtSQL) $lead_filter_sql[$i];
...
bin/AST_VDsales_export_SFTP.pl:668:select vicidial_closer_log.user,first_name,last_name,address1,address2,city,state,postal_code,vicidial_list.phone_number,vicidial_list.email,security_phrase,vicidial_list.comments,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),vicidial_list.lead_id,vicidial_users.full_name,vicidial_closer_log.status,vicidial_list.vendor_lead_code,vicidial_list.source_id,vicidial_closer_log.list_id,campaign_id,title,address3,last_local_call_time,xfercallid,closecallid,uniqueid,length_in_sec,queue_seconds,vicidial_list.list_id,vicidial_list.list_id,UTC_TIMESTAMP(vicidial_closer_log.call_date),agent_alert_delay from vicidial_list,vicidial_closer_log,vicidial_users,vicidial_inbound_groups where $with_inboundSQL $close_statusesSQL and call_date > ?/* shipdate 00:00:01 */ and call_date < ?/* shipdate 23:59:59 */ and vicidial_closer_log.lead_id=vicidial_list.lead_id and vicidial_users.user=vicidial_closer_log.user and vicidial_inbound_groups.group_id=vicidial_closer_log.campaign_id order by call_date;
bin/AST_VDsales_export_SFTP.pl:671:select vicidial_closer_log.user,8,8,8,8,8,8,8,vicidial_closer_log.phone_number,8,8,8,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),vicidial_closer_log.lead_id,vicidial_users.full_name,vicidial_closer_log.status,8,8,vicidial_closer_log.list_id,campaign_id,8,8,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),xfercallid,closecallid,uniqueid,length_in_sec,queue_seconds,vicidial_closer_log.list_id,vicidial_closer_log.list_id,UTC_TIMESTAMP(vicidial_closer_log.call_date),agent_alert_delay from vicidial_closer_log,vicidial_users,vicidial_inbound_groups where $with_inboundSQL $close_statusesSQL and call_date > ?/* shipdate 00:00:01 */ and call_date < ?/* shipdate 23:59:59 */ and vicidial_users.user=vicidial_closer_log.user and vicidial_inbound_groups.group_id=vicidial_closer_log.campaign_id order by call_date;
...
bin/AST_VDsales_export_SFTP.pl:1177:select did_pattern,did_description,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */) from vicidial_inbound_dids vid,vicidial_did_log vdl where uniqueid=?/* uniqueid */ and call_date > ?/* shipdate 00:00:01 */ and call_date <= ?/* call_date */ and vid.did_id=vdl.did_id order by call_date desc limit 1;
bin/AST_VDsales_export_SFTP.pl:1192:select vc.campaign_cid,vc.campaign_name,CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */) from vicidial_campaigns vc,vicidial_log vl where lead_id=?/* lead_id */ and call_date > ?/* shipdate 00:00:01 */ and call_date <= ?/* call_date */ and vc.campaign_id=vl.campaign_id order by call_date desc limit 1;
bin/AST_VDsales_export_SFTP.pl:1385:select CONVERT_TZ(call_date,?/* SQLtimezone */,?/* SQLoffset_timezone */),order_id,appointment_date,appointment_time,call_notes from vicidial_call_notes where lead_id=?/* lead_id */ and vicidial_id=?/* uniqueid */ and call_date > ?/* shipdate 00:00:01 */ and call_date < ?/* shipdate 23:59:59 */ order by call_date desc limit 1;
...
bin/ADMIN_keepalive_ALL.pl:1928:DELETE FROM vicidial_sip_event_log_wday_now;
bin/ADMIN_keepalive_ALL.pl:1943:INSERT IGNORE INTO vicidial_sip_event_log_wday_now SELECT * from vicidial_sip_event_log;
...
bin/ADMIN_keepalive_ALL.pl:1979:SELECT count(*) FROM vicidial_sip_event_log_wday_now;
bin/ADMIN_keepalive_ALL.pl:1989:SELECT event_date FROM vicidial_sip_event_log_wday_now order by sip_event_id LIMIT 1;
bin/ADMIN_keepalive_ALL.pl:2000:SELECT event_date FROM vicidial_sip_event_log_wday_now order by sip_event_id desc LIMIT 1;
