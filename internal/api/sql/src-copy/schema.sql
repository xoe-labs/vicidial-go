...
xfercallid INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
lead_id INT(9) UNSIGNED NOT NULL,
list_id BIGINT(14) UNSIGNED,
campaign_id VARCHAR(20),
call_date DATETIME,
...
user_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
user VARCHAR(20),
event VARCHAR(50),
campaign_id VARCHAR(8),
event_date DATETIME,
...
list_id BIGINT(14) UNSIGNED PRIMARY KEY,
...
agent_station VARCHAR(10) PRIMARY KEY,
...
remote_agent_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
agent_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
user VARCHAR(20),
server_ip VARCHAR(15) NOT NULL,
event_time DATETIME,
lead_id INT(9) UNSIGNED,
...
script_id VARCHAR(20) PRIMARY KEY,
...
callback_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
lead_id INT(9) UNSIGNED,
list_id BIGINT(14) UNSIGNED,
campaign_id VARCHAR(8),
`status` VARCHAR(10),
...
pins_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
entry_time DATETIME,
phone_number VARCHAR(18),
lead_id INT(9) UNSIGNED,
campaign_id VARCHAR(20),
...
lead_filter_id VARCHAR(20) PRIMARY KEY,
...
state_call_time_id VARCHAR(10) PRIMARY KEY,
...
recycle_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
campaign_id VARCHAR(8),
`status` VARCHAR(6) NOT NULL,
...
ivr_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
entry_time DATETIME,
...
timeclock_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
admin_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
event_date DATETIME NOT NULL,
user VARCHAR(20) NOT NULL,
...
did_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
api_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
user VARCHAR(20) NOT NULL,
api_date DATETIME,
...
group_alias_id VARCHAR(30) PRIMARY KEY,
...
user_call_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
user VARCHAR(20),
call_date DATETIME,
...
territory_id MEDIUMINT(8) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
territory VARCHAR(100) default '',
...
id_table VARCHAR(50) PRIMARY KEY,
...
calls_today INT(9) UNSIGNED default '0',
answers_today INT(9) UNSIGNED default '0',
drops_today FLOAT(12,3) default '0',
drops_today_pct VARCHAR(6) default '0',
drops_answers_today_pct VARCHAR(6) default '0',
answering_machines_today INT(9) UNSIGNED default '0',
agenthandled_today INT(9) UNSIGNED default '0'
...
trigger_id VARCHAR(20) PRIMARY KEY,
...
seqacct VARCHAR(20) NOT NULL UNIQUE,
...
parameter_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
closecallid INT(9) UNSIGNED PRIMARY KEY,
lead_id INT(9) UNSIGNED NOT NULL,
list_id BIGINT(14) UNSIGNED,
campaign_id VARCHAR(20),
call_date DATETIME,
...
xfercallid INT(9) UNSIGNED PRIMARY KEY,
lead_id INT(9) UNSIGNED NOT NULL,
list_id BIGINT(14) UNSIGNED,
campaign_id VARCHAR(20),
call_date DATETIME,
...
recording_id INT(10) UNSIGNED PRIMARY KEY,
channel VARCHAR(100),
server_ip VARCHAR(15),
extension VARCHAR(100),
start_time DATETIME,
...
agent_log_id INT(9) UNSIGNED PRIMARY KEY,
user VARCHAR(20),
server_ip VARCHAR(15) NOT NULL,
event_time DATETIME,
lead_id INT(9) UNSIGNED,
...
moh_id VARCHAR(100) PRIMARY KEY,
...
voicemail_id VARCHAR(10) PRIMARY KEY,
active ENUM('Y','N') default 'Y',
...
notesid INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
lead_id INT(9) UNSIGNED NOT NULL,
vicidial_id VARCHAR(20),
call_date DATETIME,
order_id VARCHAR(20),
...
extension_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
field_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
list_id BIGINT(14) UNSIGNED NOT NULL DEFAULT '0',
...
mdq_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
user VARCHAR(20),
...
search_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
user VARCHAR(20) NOT NULL,
event_date DATETIME NOT NULL,
...
user_skip_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
user VARCHAR(20),
event_date DATETIME,
lead_id INT(9) UNSIGNED,
campaign_id VARCHAR(20) default '',
...
url_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
uniqueid VARCHAR(50) NOT NULL,
url_date DATETIME,
...
snapshot_id INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
holiday_id VARCHAR(30) PRIMARY KEY,
...
report_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
event_date DATETIME NOT NULL,
user VARCHAR(20) NOT NULL,
ip_address VARCHAR(15) NOT NULL,
...
monitor_call_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
server_ip VARCHAR(15) NOT NULL,
callerid VARCHAR(20),
channel VARCHAR(100),
context VARCHAR(100),
...
output_code VARCHAR(30) PRIMARY KEY,
...
webserver_id SMALLINT(5) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
url_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
phrase_id INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
status_group_id VARCHAR(20) PRIMARY KEY,
...
colors_id VARCHAR(20) PRIMARY KEY,
...
api_id INT(9) UNSIGNED PRIMARY KEY,
api_date DATETIME,
...
dl_id VARCHAR(30) NOT NULL UNIQUE,
dl_name VARCHAR(100),
last_run DATETIME,
...
ip_list_id VARCHAR(30) NOT NULL UNIQUE,
...
icbq_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
icbq_date DATETIME,
...
cid_group_id VARCHAR(20) PRIMARY KEY,
...
agent_function_log_id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
leave_vm_message_group_id VARCHAR(40) PRIMARY KEY,
...
event_id int(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
server_ip varchar(15),
...
ALTER TABLE recording_log_archive MODIFY recording_id INT(10) UNSIGNED NOT NULL UNIQUE;
